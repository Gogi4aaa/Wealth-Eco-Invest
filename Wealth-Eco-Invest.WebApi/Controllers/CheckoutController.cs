...
public class CheckoutController : ControllerBase
{
	...
	[HttpPost]
	public async Task<ActionResult> CheckoutOrder([FromBody] AllAnnouncesViewModel product, [FromServices] IServiceProvider sp)
	{
	...
	[NonAction]
	public async Task<string> CheckOut(AllAnnouncesViewModel product, string thisApiUrl)
	{
